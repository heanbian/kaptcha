...
----
CaptchaUtils.CaptchaResult result = CaptchaUtils.generate(200, 60, 6, "23456789ABCDEFGHJKLMNPQRSTUVWXYZ");

System.out.println("验证码明文: " + result.text());
System.out.println("图片Base64: " + result.base64());
System.out.println("图片DataURL: " + result.dataUrl());
